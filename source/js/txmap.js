...
function showWelcome() {
    ...
    if (ipLocation) {
        let dist = getDistance(115.70548651994007, 39.39273820491569, ipLocation.result.location.lng, ipLocation.result.location.lat);  //这里换成自己的经纬度
