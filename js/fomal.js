...
$.ajax({
  ...
  data: {
    key: '8b33c382745e95bb3d3140c4f9f5fd67',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by LXDa🥝 %c 你正在访问LXDaのBlog",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| LXDa🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('LXDa🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
